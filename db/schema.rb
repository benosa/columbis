...
ActiveRecord::Schema.define(:version => 20141121065649) do
  ...
  create_table "tariff_plans", :force => true do |t|
    ...
    t.float    "price_year",                                                :default => 0.0
  end
  ...
  create_table "tourist_comments", :force => true do |t|
    t.integer  "user_id"
    t.integer  "tourist_id"
    t.text     "body"
    t.datetime "created_at", :null => false
  ...
  create_table "tourist_tasks", :force => true do |t|
    t.string   "name"
    t.string   "state"
    t.integer  "tourist_id"
    t.integer  "user_id"
  ...
  create_table "users", :force => true do |t|
    ...
    t.string   "subdomain"
    t.boolean  "export_notification",                   :default => true,  :null => false
  end
